    ...
    <main className="min-h-screen bg-padel-black text-white">
      ...
      <section className="py-20 bg-padel-black">
        <div className="max-w-5xl mx-auto px-4">
          ...
          {/* Bloque extra: Descubre K27 en Esquivias */}
          <div className="mt-8 bg-padel-black border border-padel-red/20 rounded-2xl p-6">
            <h2 className="text-2xl font-bold mb-3">Descubre K27 en Esquivias</h2>
            <p className="text-gray-300 mb-3">
              Estamos en el pueblo: acércate y anímate a probar nuestras pistas. Superficie profesional, iluminación LED y ambiente de club.
            </p>
            ...
            <div className="space-y-4">
              <div className="bg-padel-gray rounded-2xl border border-padel-red/20 p-6">
                <blockquote className="text-gray-300 italic">
                  “Vivo en Esquivias y las pistas de K27 se notan de primera. Ideal para jugar entre semana con amigos.”
                </blockquote>
                <p className="text-gray-400 mt-3">— David R. (Esquivias)</p>
              </div>
              <div className="bg-padel-gray rounded-2xl border border-padel-red/20 p-6">
                <blockquote className="text-gray-300 italic">
                  “Nos apuntamos a un partido y el nivel fue perfecto. El trato del personal, de 10.”
                </blockquote>
                <p className="text-gray-400 mt-3">— Sandra V. (Esquivias)</p>
              </div>
              <div className="bg-padel-gray rounded-2xl border border-padel-red/20 p-6">
                <blockquote className="text-gray-300 italic">
                  “Pistas nuevas y buen ambiente en el club. Muy recomendable.”
                </blockquote>
                <p className="text-gray-400 mt-3">— Jorge M. (Yeles)</p>
              </div>
            </div>
          </section>
              ...
              <div className="bg-padel-gray rounded-xl border border-padel-red/20 overflow-hidden">
                <details className="group">
                  ...
                  <div className="px-5 pb-5 text-gray-300">
                    Pulsa “Gestiona tu reserva” o llama al <span className="text-white font-semibold">+34 644 337 496</span>.
                  </div>
                </details>
              </div>
              <div className="bg-padel-gray rounded-xl border border-padel-red/20 overflow-hidden">
